...
import { faBook, faRectangleList, faDesktop, faUserPlus, faBackward, faChartSimple } from '@fortawesome/free-solid-svg-icons';
...
const MentorClassroom = () => {
  ...
  const icons = [faBackward,faChartSimple,faBook, faRectangleList, faDesktop, faUserPlus];
  ...
  const menuItems = [
    { name: "Dashboard", route: `Mentor-My-Courses` },
    { name: "Class Analysis", route: `Mentor-Classroom/${class_Info?.classInfo._id}/Class-Analysis` },
    { name: "Materials", route: `Mentor-Classroom/${class_Info?.classInfo._id}/Materials` },
    { name: "Assignments", route: `Mentor-Classroom/${class_Info?.classInfo._id}/Assignments` },
    { name: "Live Classes", route:`Mentor-Classroom/${class_Info?.classInfo._id}/Live-Classes` },
    { name: "Join Invitations", route: `Mentor-Classroom/${class_Info?.classInfo._id}/Join-Invitations` },
  ];

  return (
    <div className="flex flex-col h-screen overflow-hidden">
      <Navbar avatar={avatar} name={name} isStudent={false}
      />
