  ...
  return (
    <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12 ">
      <div className="absolute top-4 left-4">
        ...
        <button onClick={() => navigate('/Mentor-My-Courses')} className="text-xl text-cyan-800 hover:text-cyan-600">
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="mt-6">
              <dl className="grid grid-cols-2 gap-x-4 gap-y-8">
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <dd className="mt-1 text-m text-cyan-800">
                    {email}
                  </dd>
                </div>
                <div className="col-span-2 sm:col-span-1">
                ...
                {/* <div className="col-span-2 sm:col-span-1">
                  ...
                  <dd className="mt-1 text-m text-gray-900">
                    {institution}
                  </dd>
                </div> */}
                {/* <div className="col-span-2 sm:col-span-1">
            ...
            <div className="mt-14 text-center">
              <button
                ...
                className="bg-cyan-500 hover:bg-cyan-700 text-white font-bold py-2 px-4 
                rounded mx-6"
              >
                Change Password
              </button>
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="mt-2">
                  <input
                    ...
                    className="w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-cyan-500 focus:border-cyan-700"
                  />
                  {selectedImage && (
